...
class PatronController extends Controller
{
     ...
     * @queryParam email required Email address of patron. Must be unique. Example: yvansabay61131@gmail.com
     * 
     * @response 200 {
     * "last_name": "Sabay",
     * "first_name": "Yvan",
     ...
     * 
     * @urlParam patron integer required Refers to the ID of the patron to be retrieved. Example: 4
     * 
     * @response 200 {
     * "id": 4,
     * "last_name": "Dibbert",
     ...
     * 
     * @urlParam patron integer required ID of the patron to update. Example: 10
     * 
